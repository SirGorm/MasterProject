...
DATASET_PATH = Path(r"C:\MasterProject\VS_Camera\Test_modify\dataset")
...
SIGNALS: Dict[str, SignalConfig] = {
    ...
    'eda': SignalConfig(name='eda', sampling_rate=50.0, channels=1, file_name='biopoint_eda.csv'),
    ...
    'joints': SignalConfig(name='joints', sampling_rate=30.0, channels=96, file_name='joint_data.json', enabled=False),
}
