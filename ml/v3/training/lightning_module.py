...
from ml.v3.models import StrengthTrainingModel, MultiTaskLoss
from ml.v3.evaluation import PredictionTracker, visualize_prediction, visualize_prediction_with_skeleton
...
class StrengthTrainingLitModule(pl.LightningModule):
    ...
    def __init__(self, config=None, rep_pos_weight: float = 1.0):
        super().__init__()
